...
function Finish() {
  ...
  // http://localhost:3000/tora/user/finish/pWB6GLUNxs8Tp74QZd3E
  ...
  return (
    <div className="max-w-full min-h-screen flex bg-backgroundWeb">
      ...
      {/* end body1 */}
      {/* start body2 */}
      <div className="max-h-full xl:w-[62%]">
        <div className="xl:ml-32 ml-12 mr-12 mt-8 xl:mt-4 pb-12">
          ...
          <div className="mt-14 xl:mt-18">
            ...
            <div className="mt-2 xl:w-[70%]">
              <span className="textDesc">
                Berikan catatan sesuai dengan keinginan kamu sendiri atau
                sekilah mirip catatan.
              </span>
            </div>
            {/* textInput */}
            <div className="mt-12">
              <form>
                <span className="text-[14px] xl:text-[16px] font-[500] font-sans">
                  Catatan (opsional)
                </span>
                <br />
                <textarea
          ...
          <div className="bottom-0 mt-8">
            <div className="xs:block flex justify-between relative mt-8 lg:mt-4 pb-12">
              <Button
                label={"Kembali"}
                icon="back"
                mode={"outline"}
